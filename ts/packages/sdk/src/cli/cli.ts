...
const HELP =
  ...
  "  sponsio skill install",
    ...
    "  validate [path]            Parse sponsio.yaml + report contract counts (sto contracts flagged as Cloud-only)",
    "  patterns [--category …]    List deterministic pattern templates available in TS",
