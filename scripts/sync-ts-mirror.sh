...
#
# Canonical Python -> TS mirror runner. Copies the resources that must
...
echo "      diff -u $PY/skills/sponsio/SKILL.md $TS_SDK/skills/SKILL.md | head"
echo "  • Demo scenarios in $TS_SDK/src/cli/demo.ts (hand-port from sponsio/demos/)"
